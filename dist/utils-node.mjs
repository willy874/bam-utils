...
const readDirectory = async function (url, options) {
    ...
    const dirData = await Promise.all(dir.map((file) => readFileTree(path.join(url, file), options)));
